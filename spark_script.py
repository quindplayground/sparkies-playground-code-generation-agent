...
# from quind_demo_ppd_project.flows.stage.your_flow.job import your_job_function

from quind_demo_ppd_project.libs.args import get_args
from quind_demo_ppd_project.libs.runner import JobRunner
from quind_demo_ppd_project.libs.resources import get_vars_resource, SparkResource
...
from quind_demo_ppd_project.libs.validation import validate_json_parameters
from quind_demo_ppd_project.libs.exceptions import ValidationError
...
if __name__ == "__main__":
    ...
    # Ensure 'quind_demo_ppd_project' matches your actual package name
    root_path = get_package_resource_path("quind_demo_ppd_project")
