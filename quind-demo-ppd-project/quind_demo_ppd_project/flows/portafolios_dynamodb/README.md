...
```bash
# From project root
cd quind-demo-ppd-project/quind_demo_ppd_project/flows
...
1. **`job.py`**:
   ...
   - Import paths: `from quind_demo_ppd_project.flows._template_flow.*` → `from quind_demo_ppd_project.flows.your_flow_name.*`
...
```python
# Before:
from quind_demo_ppd_project.flows._template_flow.extract import extract
from quind_demo_ppd_project.flows._template_flow.load import load
from quind_demo_ppd_project.flows._template_flow.transform import transform

# After:
from quind_demo_ppd_project.flows.your_flow_name.extract import extract
from quind_demo_ppd_project.flows.your_flow_name.load import load
from quind_demo_ppd_project.flows.your_flow_name.transform import transform
```
...
```python
from quind_demo_ppd_project.flows.your_flow_name.steps.step_100_clean_data import step_100_clean_data
from quind_demo_ppd_project.flows.your_flow_name.steps.step_200_cast_types import step_200_cast_types
...
from quind_demo_ppd_project.libs.iceberg.utils import is_empty
...
from quind_demo_ppd_project.libs.iceberg.cdc_with_tagging_strategy import SnapshotManager
...
from quind_demo_ppd_project.libs.iceberg.utils import restart_table
...
```python
from quind_demo_ppd_project.flows.your_flow_name.steps.step_100_remove_duplicates import step_100_remove_duplicates
from quind_demo_ppd_project.flows.your_flow_name.steps.step_200_cast_types import step_200_cast_types
...
def test_full_flow_execution(spark: SparkSession, mock_vars_resource: VarsResource):
    ...
    from quind_demo_ppd_project.flows.your_flow_name.job import your_flow_name_job
...
**Problem:** `ImportError: cannot import name 'extract' from 'quind_demo_ppd_project.flows.your_flow_name.extract'`
...
- `quind_demo_ppd_project.libs.iceberg.utils`: Table operations
...
- `quind_demo_ppd_project.libs.iceberg.cdc_with_tagging_strategy`: CDC operations
  - `ChangelogManager`: Manage changelog extraction
  - `SnapshotManager`: Manage snapshot tagging

### Core Utilities

- `quind_demo_ppd_project.libs.error_handler`: Error handling decorator
- `quind_demo_ppd_project.libs.logging`: Structured logging
- `quind_demo_ppd_project.libs.resources`: Configuration management
- `quind_demo_ppd_project.libs.common_patterns`: Common transformation patterns
