...
def get_vars_resource(
    ...
    Raises:
        ModuleNotFoundError: If quind_demo_ppd_project package is not found.
    """
    try:
        root = get_package_resource_path("quind_demo_ppd_project")
    except Exception:
        raise ModuleNotFoundError("quind_demo_ppd_project package not found")
