...
```bash
pip install -e quind-demo-ppd-project
```

3. **Verificar la instalación:**
```bash
python -c "import quind_demo_ppd_project; print(template_project.__version__)"
```

## Estructura del Proyecto

```
quind-demo-ppd-project/
├── quind_demo_ppd_project/                    # Paquete principal
...
├── quind_demo_ppd_project_tests/              # Tests del proyecto
...
- **`quind_demo_ppd_project_tests/`**: Suite completa de tests unitarios que sigue las mejores prácticas de pytest.
...
```python
from quind_demo_ppd_project.libs.runner import JobRunner
from quind_demo_ppd_project.libs.runner.types import JobDefinition, Status
...
**Nombre:** `quind_demo_ppd_project.libs.aws.s3` — módulo
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.aws.s3 import download_s3_folder_to_local
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.logging` para logging estructurado
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/aws/s3/download_utils.py`
- AWS S3: https://docs.aws.amazon.com/s3/

#### DynamoDB Utilities (`libs/aws/dynamodb/`)

**Nombre:** `quind_demo_ppd_project.libs.aws.dynamodb` — módulo
...
from quind_demo_ppd_project.libs.aws.dynamodb.truncate_table import truncate_table
from quind_demo_ppd_project.libs.aws.dynamodb.loader.utils import get_table
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.logging`, `quind_demo_ppd_project.libs.resources`
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/aws/dynamodb/loader/loader.py`
- Handlers: `template_project/libs/aws/dynamodb/loader/handlers/`
- AWS DynamoDB: https://docs.aws.amazon.com/dynamodb/

### Error Handler (`libs/error_handler/`)

**Nombre:** `quind_demo_ppd_project.libs.error_handler` — módulo
...
from quind_demo_ppd_project.libs.error_handler.handler import get_error_handler
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/error_handler/decorator.py`
...
**Nombre:** `quind_demo_ppd_project.libs.iceberg` — módulo
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.iceberg.utils import load_overwrite, is_empty, restart_table
...
from quind_demo_ppd_project.libs.iceberg.utils import run_daily_maintenance, run_weekly_maintenance
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/iceberg/utils/`
- CDC: `template_project/libs/iceberg/cdc_with_tagging_strategy/`
- Apache Iceberg: https://iceberg.apache.org/

### Logging Utilities (`libs/logging/`)

**Nombre:** `quind_demo_ppd_project.libs.logging` — módulo
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.logging import get_logger, Logger
...
from quind_demo_ppd_project.libs.logging import Logger, OtelStyleJsonFormatter
...
from quind_demo_ppd_project.libs.context import Context
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.resources.spark_resource`, `quind_demo_ppd_project.libs.context`
...
from quind_demo_ppd_project.libs.logging import Logger
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/logging/logger.py`
...
**Nombre:** `quind_demo_ppd_project.libs.resources` — módulo
...
Ejemplo mínimo:
```python
from quind_demo_ppd_project.libs.resources import SparkResource, get_vars_resource
...
from quind_demo_ppd_project.libs.resources.vars.zip_handler import get_working_path
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.utils` para rutas de paquetes
...
from pyspark import SparkConf
from quind_demo_ppd_project.libs.resources import SparkResource
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/resources/spark_resource.py`
...
**Nombre:** `quind_demo_ppd_project.libs.runner` — módulo
...
from quind_demo_ppd_project.libs.runner.executors import ExecutorFactory
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.exceptions`, `quind_demo_ppd_project.libs.logging`
...
from quind_demo_ppd_project.libs.runner.executors.base import IExecutor
from quind_demo_ppd_project.libs.runner.types import JobDefinition, Status
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/runner/job_runner.py`
...
**Nombre:** `quind_demo_ppd_project.libs.validator_utils` — módulo
...
Ejemplo mínimo:
```python
from quind_demo_ppd_project.libs.validator_utils import validate_json_parameters
from quind_demo_ppd_project.libs.validator_utils.validators import (
...
**Dependencias:**
- Internas: `quind_demo_ppd_project.libs.resources`, `quind_demo_ppd_project.libs.logging`
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/validator_utils/parameters_validation.py`
...
**Nombre:** `quind_demo_ppd_project.libs.args` — módulo
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.args import get_args
...
from quind_demo_ppd_project.libs import Context
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/args.py`
- argparse: https://docs.python.org/3/library/argparse.html

#### Common Patterns (`common_patterns.py`)

**Nombre:** `quind_demo_ppd_project.libs.common_patterns` — módulo
...
Ejemplo mínimo:
```python
from quind_demo_ppd_project.libs.common_patterns import clean_spaces_and_tabs
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.common_patterns import (
...
**Ejemplos adicionales:**
```python
from quind_demo_ppd_project.libs.common_patterns import clean_spaces_and_tabs, safe_isin_filter
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/common_patterns.py`
- PySpark: https://spark.apache.org/docs/latest/api/python/

#### Context (`context.py`)

**Nombre:** `quind_demo_ppd_project.libs.context` — clase
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/context.py`
- Threading: https://docs.python.org/3/library/threading.html

#### Exceptions (`exceptions.py`)

**Nombre:** `quind_demo_ppd_project.libs.exceptions` — módulo
...
Ejemplo mínimo:
```python
from quind_demo_ppd_project.libs.exceptions import TableNotFoundError
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.exceptions import (
    TableNotFoundError, 
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/exceptions.py`
- Python Exceptions: https://docs.python.org/3/tutorial/errors.html

#### Utils (`utils.py`)

**Nombre:** `quind_demo_ppd_project.libs.utils` — módulo
...
Ejemplo mínimo:
```python
from quind_demo_ppd_project.libs.utils import get_package_resource_path
...
**Uso básico:**
```python
from quind_demo_ppd_project.libs.utils import get_package_resource_path, get_key_by_value
...
**Referencias:**
- Código: `quind_demo_ppd_project/libs/utils.py`
