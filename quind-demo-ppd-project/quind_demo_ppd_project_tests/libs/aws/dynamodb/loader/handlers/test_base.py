...
from quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base import (
...
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.get_table")
...
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.get_table")
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.get_logger")
...
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.get_table")
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.is_retryable_error")
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.time.sleep")
@patch("quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.base.get_logger")
