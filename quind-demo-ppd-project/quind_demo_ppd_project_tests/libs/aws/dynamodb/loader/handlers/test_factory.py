import pytest
from quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.factory import (
    HandlerFactory,
)
from quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.portfolio_write_handler import (
    PortfolioDynamoDBWriteHandler,
)
from quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.comercial_write_handler import (
    ComercialDynamoDBWriteHandler,
)
from quind_demo_ppd_project.libs.aws.dynamodb.loader.handlers.delete_handler import (
