...
_filter_path = (
    ...
    / "quind_demo_ppd_project"
    / "quind_demo_ppd_project"
    / "libs"
    / "logging"
    / "filter.py"
)
# La ruta correcta es quind-demo-ppd-project/quind_demo_ppd_project/libs/logging/filter.py
_filter_path = (
    Path(__file__).parents[3] / "quind_demo_ppd_project" / "libs" / "logging" / "filter.py"
)
