...
from quind_demo_ppd_project.libs.iceberg.cdc_with_tagging_strategy.exceptions import (
    ChangelogManagerException,
)
from quind_demo_ppd_project.libs.exceptions import ColumnsNotMatchedError
...
@patch("quind_demo_ppd_project.libs.logging.get_logger")
