...
@patch("quind_demo_ppd_project.flows.portafolios_dynamodb.transform.step_400_compress_productos")
@patch("quind_demo_ppd_project.flows.portafolios_dynamodb.transform.step_300_build_dynamodb_keys")
@patch("quind_demo_ppd_project.flows.portafolios_dynamodb.transform.step_200_group_and_aggregate")
@patch("quind_demo_ppd_project.flows.portafolios_dynamodb.transform.step_100_filter_active_records")
...
def test_transform_empty_input(
    ...
    empty_final_df = spark.createDataFrame([], schema=StructType([
    ...
    mock_step_400.return_value = empty_final_df
    ...
    assertDataFrameEqual(result, empty_final_df)
...
def test_transform_logging(
    ...
    assert any("Transformation started" in msg for msg in log_calls)
    ...
    assert any("Transformation completed" in msg for msg in log_calls)
