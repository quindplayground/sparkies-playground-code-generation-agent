...
@patch("template_project.flows.portafolios_dynamodb.job.get_logger")
@patch("template_project.flows.portafolios_dynamodb.job.load")
@patch("template_project.flows.portafolios_dynamodb.job.transform")
@patch("template_project.flows.portafolios_dynamodb.job.extract")
@patch("template_project.flows.portafolios_dynamodb.job.SnapshotManager")
def test_job_first_run_success(
    ...
    assert "initial_load" in result.message
...
@patch("template_project.flows.portafolios_dynamodb.job.transform")
@patch("template_project.flows.portafolios_dynamodb.job.extract")
@patch("template_project.libs.iceberg.cdc_with_tagging_strategy.ChangelogManager")
@patch("template_project.flows.portafolios_dynamodb.job.SnapshotManager")
def test_job_subsequent_run_with_changes(
    ...
    assert result.status_value == "OK"
    assert "completed successfully" in result.message
    assert "incremental_load" in result.message
    ...
    mock_changelog_manager.commit_changes.assert_called_once()
...
@patch("template_project.flows.portafolios_dynamodb.job.get_logger")
@patch("template_project.flows.portafolios_dynamodb.job.restart_table")
@patch("template_project.flows.portafolios_dynamodb.job.load")
@patch("template_project.flows.portafolios_dynamodb.job.transform")
@patch("template_project.flows.portafolios_dynamodb.job.extract")
@patch("template_project.flows.portafolios_dynamodb.job.SnapshotManager")
