...
@patch("template_project.flows.portafolios_dynamodb.transform.get_logger")
@patch("template_project.flows.portafolios_dynamodb.transform.step_400_format_output")
@patch("template_project.flows.portafolios_dynamodb.transform.step_300_build_keys")
@patch("template_project.flows.portafolios_dynamodb.transform.step_200_group_and_aggregate")
@patch("template_project.flows.portafolios_dynamodb.transform.step_100_filter_active")
...
@patch("template_project.flows.portafolios_dynamodb.transform.logger")
@patch("template_project.flows.portafolios_dynamodb.transform.step_400_format_output")
@patch("template_project.flows.portafolios_dynamodb.transform.step_300_build_keys")
@patch("template_project.flows.portafolios_dynamodb.transform.step_200_group_and_aggregate")
@patch("template_project.flows.portafolios_dynamodb.transform.step_100_filter_active")
